...
public class BizCard_Test {

	private static String URL = "http://test.api.hcicloud.com:8880/ocr/auto_recognise";
	...
	private static String cap_key = "ocr.cloud.bizcard";
	...
	public static void main(String[] args) {
		...
		try{
			...
			filepath = new String(System.getProperty("user.dir") + "\\wav\\BizCard.jpg");
